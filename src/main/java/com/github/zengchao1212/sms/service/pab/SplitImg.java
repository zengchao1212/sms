...
public class SplitImg {
    public static void main(String[] args) throws IOException, InterruptedException {
        try {
            Process p = Runtime.getRuntime().exec("rm -rf /Users/zengchao/Documents/pab/one/all");
            p.waitFor();
            p = Runtime.getRuntime().exec("mkdir -p /Users/zengchao/Documents/pab/one/all");
            p.waitFor();
        } catch (IOException e) {
            e.printStackTrace();
            System.exit(-1);
        ...
        for (File img : dir.listFiles((d, n) -> n.contains("gif"))) {
            ...
            name = name + ".bmp";
            ImageIO.write(b1, "bmp", new File("/Users/zengchao/Documents/pab/one/all/" + name));
//            Files.copy(Paths.get(img.getAbsolutePath()),Paths.get("/Users/zengchao/Documents/pab/one/all/"+fullName));
