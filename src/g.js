try {
    !function (e, t) {
        ...
        var T, M, i, D, F, k, c, d, u, f, v, l, A, V, s, j, h, L, G, m, p, E, y, _, I, U, C, R, K, P, B, l, Y, H,
            O = 26, X = 0;
        if (n.prototype = {
            "int": function (e) {
                ...
                U = function () {
                    ...
                    return this.setOnError = function (e) {
                        ...
                        e.addEventListener ? t.addEventListener("DOMContentLoaded", function () {
                            ...
                            if (t.uniqueID || !t.expando) {
                                var e = t.createElement("docmt:ready");
                                try {
                                    e.doScroll("left"),
                                        i()
                                } catch (n) {
    ...
    try {
        !function () {
            var t = function (e) {
                var t = new Image;
                t.src = "//www.baidu.com/error?e=" + e + "&u=" + navigator.userAgent
            };
            t(e)
        }()
    } catch (e) {
